...
function Set-PowerPlanSettings {
    ...
    POWERCFG /SETACVALUEINDEX SCHEME_CURRENT SUB_BATTERY BATLEVELLOW  75
    POWERCFG /SETDCVALUEINDEX SCHEME_CURRENT SUB_BATTERY BATLEVELLOW  75
    POWERCFG /SETACVALUEINDEX SCHEME_CURRENT SUB_BATTERY BATLEVELCRIT 50
    POWERCFG /SETDCVALUEINDEX SCHEME_CURRENT SUB_BATTERY BATLEVELCRIT 50
