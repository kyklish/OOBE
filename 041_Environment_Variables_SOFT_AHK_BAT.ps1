Write-Warning "Portable programs should not be in the root of the disk!"
Write-Warning "    X:\AT_LEAST_ONE_DIRECTORY_FROM_THE_ROOT\_OOBE_"
...
Write-Warning "First run will fail to check results! Restart Explorer & Q-Dir."
Write-Warning "Second run must show correct results!"

############################## Restart Explorer ################################

"`n"
"!!!Restart Explorer & Q-Dir to apply new environment variables!!!"
# In case of any problems search on PC: [windows - How do you add a Windows environment variable without rebooting.rar]
