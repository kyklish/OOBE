Write-Warning "Run this script only from true 64bit application, for example: Explorer..."
"Enabling [System Protection] on disk [C:]..."
Enable-ComputerRestore -Drive C:

"Resizing disk space usage to 4GB..."
