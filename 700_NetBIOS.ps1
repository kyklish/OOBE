...
# "Disabling DHCP for default [Ethernet] network adapter..."
# Set-NetIPInterface -InterfaceAlias "Ethernet" -Dhcp "Disabled"
# Start-Sleep -Seconds 5
# "Setting a [Static IP] for default [Ethernet] network adapter..."
...
"`n"
"Disabling NetBIOS over TCP/IP on all network adapters with IP addresses..."
...
# "Setting a [Dynamic IP] (DHCP) for default [Ethernet] network adapter..."
